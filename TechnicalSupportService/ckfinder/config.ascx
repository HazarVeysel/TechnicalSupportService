...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = "/Content/QuestionsImages/" + (Session["CurrentId"]) + "/";

        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = HttpContext.Current.Server.MapPath("~/Content/QuestionsImages/");
        ...
        type.Url = BaseUrl;
        type.Dir = BaseDir == "" ? "" : BaseDir +  (Session["CurrentId"]) + "/";
        type.MaxSize = 0;
